  ...
  teams: [
    {
      ...
      projectName: "HoneyBe",
      hashTag:
        "#AndroidStudio   #SpringBoot   #MongoDB   #Recommendation System   #AWS   #EC2   #전남대학교   #소개팅   #모바일앱",
      subTitle: "전남대학교 학생들의 새로운 만남을 응원하는 그곳, HoneyBe !",
    ...
    },
    {
      ...
      projectName: "WE:ART",
      hashTag:
        "#WEB   #ART   #예술품   #경매   #React   #AtomicDesign   #Storybook   #SpringBoot   #SpringDataJPA   #MySQL",
...
백엔드는 Spring Boot와 Spring Data JPA를 이용하여 웹 어플리케이션을 개발하였고, 관계형 데이터베이스인 MySQL을 사용하였습니다.`,
    ...
    },
    {
      ...
      hashTag:
        "#Peace Maker   #끼룩   #게임   #추리   #카페   #C#   #Unity   #탑다운",
      subTitle:
    ...
    },
    {
      ...
      hashTag:
        "#굿데이   #네잎클로버   #MBTI   #IOS   #Swift   #이별극복서포팅",
      subTitle:
    ...
    },
    {
      ...
      hashTag:
        "#성장   # iOS   #플랫폼   #Springboot   #교감   #유대   #모바일   #Figma   #오감자",
      subTitle:
    ...
    },
    {
      ...
      projectName: "카페가네",
      hashTag:
        "#카페추천   #시그니처음료   #개발자_디자이너   #html   #css   #VanillaJS   #NodeJS   #mySQL   #adobeillustration",
    ...
    },
    {
      ...
      hashTag:
        "#TRPG   #크툴루의 부름   #추리   #미스터리   #유니티   #PC게임   #심리적 공포",
    ...
    },
    {
      ...
      projectName: "오늘의 칵테일",
      hashTag:
        "#칵테일   #감정   #추천   #NLP   #Transformer   #PyTorch   #KoBERT",
    ...
    },
    {
      ...
      hashTag:
        "#음악   #협업   #Convention   #React   #CSR   #MVVM   #Recoil   #TypeScript   #Swagger   #Spring Boot   #Spring Web MVC   #Spring Data Jpa   #Pair Programming",
      subTitle: "온라인 작사 작곡 협업 웹 사이트",
      idea:
        "요즘 나오는 좋은 노래들, 혼자서 작곡하는 걸까요? 실제로 요즘 나오는 곡들 중 절반 이상이 공동 작곡 형태로 발매됩니다. 사실 대형 엔터테인먼트에서는 일찍부터 해외 유명 프로듀서들과 국내 탑 프로듀서들이 모여 협업을 하는 송캠프를 진행하고 있습니다. 하지만 이 송캠프는 많은 비용이 들뿐더러 공간적 제약이 존재하여 탑 프로듀서가 아닌 대부분의 프로듀서들은 지원조차 하지 못하는 상황입니다. 그래서 저희 collusic은 시대에 맞는 온라인 작사 작곡 협업 웹 애플리케이션 서비스를 제안합니다.",
