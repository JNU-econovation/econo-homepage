export const winter2026 = [
  {
    ...
    INTRODUCTION: [
      {
        TYPE: "image",
        LINK: require("/public/dev/2025_winter_dev_real/portfolio/BossEffector/1.png")
          .default,
      },
    ],
  },
  ...
  },
  {
    ...
    PEOPLE: "",
    IDEA:
      "지속적인 학습을 돕는 수집형 스터디 플랫폼입니다. 뭉탱이는 스터디를 아이콘 수집이라는 보상 구조로 이어가도록 돕는 경험을 제공합니다. 스터디 참여가 아이콘으로 기록되어, 사용자는 자신의 진행 흐름을 한눈에 확인할 수 있으며 아이콘 수집 구조를 통해 스터디를 부담이 아닌 계속 이어가고 싶은 경험으로 만듭니다.",
    SKILLS: "React, TypeScript, Spring Boot, MySQL, AWS, Docker",
    BG_IMAGE: require("/public/dev/2025_winter_dev_real/portfolio/MungTangyee/bg.png")
      .default,
    YEAR: "2025-2",
    LINKS: null,
    INTRODUCTION: [
      {
        TYPE: "image",
        LINK: require("/public/dev/2025_winter_dev_real/portfolio/MungTangyee/1.png")
          .default,
      },
    ],
  },
