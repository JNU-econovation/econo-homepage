const FAQ = [
  ...
  },
  {
    ...
    DATA: [
      ...
      {
        Q: "인터뷰 일정을 조정하고 싶은데, 가능할까요?",
        A: "에코노베이션 카카오톡 오픈채널에 문의하시면 조정이 가능한지 알려드립니다.",
      },
      {
        Q: "인터뷰 결과는 언제 받아볼 수 있나요?",
        A: "인터뷰 결과는 인터뷰 마감일로부터 일주일 정도 후에 메일로 안내드리고 있으며,\n메일이 전송되었다는 문자를 발송해드립니다.",
      },
    ],
  },
  {
    ...
    DATA: [
      ...
      {
        Q: "주간 발표는 어떻게 진행되나요?",
        A: "A팀, B팀 발표로 나누어져 한 주씩 진행되며 프로젝트를 진행하며 부딪쳤던 어려움과 그것을 어떻게 해결했는지에 대한 내용,\n해당 과정을 거치며 얻었던 부분에 대해 공유합니다.",
      },
      {
        Q: "에코노베이션에 들어가면 주로 어떤 활동을 하게되나요?",
        A: "에코노베이션은 매 학기 한 가지 주제를 가지고 실제 동작하는 서비스를 구현하는 프로젝트를 진행 합니다. 기한만 정해져 있는 프로젝트를 진행할 뿐만 아니라 의무적으로 매주 금요일에 모여서 프로젝 트의 진행 상황과 공부한 내용을 공유하고 피드백을 주고받는 시간을 가집니다. 한 학기 동안 진행한 프로젝트는 DEV 행사에서 성과를 공유합니다.",
      },
      {
        Q: "프로젝트팀은 어떻게 구성하나요?",
