  ...
  },
  {
    ...
    DATA: [
      ...
      },
      {
        ...
        A: "에코노베이션은 매 학기 한 가지 주제를 가지고 실제 동작하는 서비스를 구현하는 프로젝트를 진행 합니다. 기한만 정해져 있는 프로젝트를 진행할 뿐만 아니라 의무적으로 매주 금요일에 모여서 프로젝트의 진행 상황과 공부한 내용을 공유하고 피드백을 주고받는 시간을 가집니다. 한 학기 동안 진행한 프로젝트는 DEV 행사에서 성과를 공유합니다.",
      },
      {
        Q: "프로젝트팀은 어떻게 구성하나요?",
