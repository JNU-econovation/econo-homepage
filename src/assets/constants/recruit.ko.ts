    ...
    TYPE: [
      {
        ...
        TRANSLATION: "기획자",
        CONTENT:
          "사용자 경험 향상을 위한 아이디어를 내고, 서비스를 기획합니다.\n 그리고 디자이너, 개발자와 소통해 서비스를 만듭니다. 일정 관리와 프로젝트 또한 PM의 역활입니다.",
      },
      {
...
const RECRUIT_FLOAT = {
  ...
  ECONO_PERIOD_RECRUIT_EN: `econovation ${RECRUIT.PERIOD} period recruit`,
  ECONO_PERIOD_RECRUIT_KR: `에코노베이션 ${RECRUIT.PERIOD}기 신입 모집`,
  DAY: "day",
  HOUR: "hour",
  MINUTE: "minute",
  SECOND: "second",
