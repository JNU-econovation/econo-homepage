    ...
    <div id="main" className="wrapper style1">
      <div className="container">
        <header className="major pur">
          <h2>2022-1 ECONOVATION RECRUIT</h2>
        </header>
        ...
        >
          ...
          <img src="assets/22_1_recruit.jpg" width="100%" />
          <br />
          <br />
          <section style={{ width: "100%" }}>
            ...
            <h4>
              ...
              개발분야와 IT관련 디자인/기획 분야에서 활동해 주실 23기 회원들을
              모집합니다.
            </h4>
            <ul>
          ...
          <section style={{ width: "100%" }}>
            ...
            <ul>
              <li>
                <h3>서류지원: 3월 7일(월) ~ 3월 22일(화) 23:59</h3>
              </li>
              <li>
