    ...
    <div id="main" className="wrapper style1">
      <div className="container">
        <header className="major pur">
          <h2>2022-2 ECONOVATION RECRUIT</h2>
        </header>
        ...
        >
          ...
          <img src="assets/22_2_recruit.jpg" width="100%" />
          <br />
          <br />
          <section style={{ width: "100%" }}>
            <h2>Econovation 24기 신입회원 모집</h2>
            <blockquote>
            ...
            <ul>
              ...
              <li>
                IT관련 디자인/기획 - IT서비스를 위한 기획과 UI 디자인 혹은
                시스템 디자인
              </li>
            </ul>
            <br />
          ...
          <section style={{ width: "100%" }}>
            ...
            <ul>
              <li>
                <h3>서류지원: 9월 5일(월) ~ 9월 16일(금) 23:59</h3>
              </li>
              <li>
                <h3 style={{ "margin-bottom": "0" }}>
                  오프라인 면접: 9월 22일(목), 9월 24일(토) ~ 9월 25일(일)
                </h3>
