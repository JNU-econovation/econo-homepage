...
function Winter23() {
    ...
    return (
        <div id="main" class="wrapper style1">
            <div class="container">
                <img src="assets/2023_winter_dev/2023WinterDev.png" width="100%" />
                <header>
                    <h2 class="big-header">2022-2학기 에코노베이션이 개발한 프로젝트 미리보기</h2>
                </header>
                <section>
                    <br />
                        ...
                        {Object.keys(data).map((k) => (
                            <div>
                                <div class="grid-item" onClick={() => showModal(k)} style={{ animationDelay: `${k * 0.1}s` }}>
                                    ...
                                    <strong>
                                        [{data[k].field}] {data[k].project_name}
                                    </strong>
                                    <div>{data[k].team}</div>
                                ...
                                <div id={`modal${k}`} class="modal">
                                    <div class="modal-content">
                                        ...
                                        <div class="description">
                                            ...
                                            {data[k].link
                                                ? data[k].link.map((e) => (
                                                      <a href={e.uri} class="project-link" target="_blank">
                                                          {e.title}
                                                      </a>
                                                  ))
                                                : null}
